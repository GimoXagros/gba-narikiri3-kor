...
def main():
    ...
    run('build_small_font_experiment.py',['--j',j,'--ips',ips,'--toolchain',tc,'--out',out,
        ...
        '--recipes',ROOT/'translations/recipes.json','--battle-captions',ROOT/'translations/battle_captions.json','--name-keyboard','--skill-headers','--biographies','--clothing-results'])
